        ...
        <div className=" border-2 m-auto lg:w-3/4 mt-5">
          ...
          <div className="text--editor  mt-5 p-5">
            {policyState === true ? (
              ...
              <div>
                {" "}
                {websiteData?.privacyPolicy &&
                  parse(websiteData?.privacyPolicy)}
              </div>
            )}{" "}
            {/* put editor here */}
          </div>
          ...
          <div className="mb-3 flex justify-end px-4">
            <button type="button" onClick={editFunction} className="bg-[#059DB0] p-3 rounded text-white font-semibold w-[80px]">
              Save
            </button>
            </div>
          )}
